...
use App\Http\Requests\Facility\Elimination\NextLevelEliminationRequest;
use App\Http\Requests\Facility\Elimination\StartEliminationRequest;
use App\Http\Requests\Facility\Elimination\UpdateEliminationRequest;
use App\Http\Requests\Facility\Elimination\StoreEliminationRequest;
...
class EliminationController extends Controller
{
    ...
    public function index()
    {
        ...
        $eliminations = $this->eliminationRepository->findByFacilityId($facility->id);
        return view('facility.elimination.index', compact('eliminations'));
    }
    ...
    {
        return view('facility.elimination.create');
    }
    ...
    public function store(StoreEliminationRequest $request)
    {
        ...
        return redirect()->route('facility.elimination.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('facility.elimination.show', compact('elimination'));
    }
    ...
    {
        $elimination = $this->eliminationRepository->findById($id);
        return view('facility.elimination.edit', compact('elimination'));
    }
    ...
    public function update(UpdateEliminationRequest $request, $id)
    {
        ...
        return redirect()->route('facility.elimination.show', $id);
    }
    ...
    public function start(StartEliminationRequest $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('facility.elimination.matches', $id);
        } catch (\Exception $ex) {
            DB::rollBack();
    ...
    {
        $elimination = $this->eliminationRepository->findById($id);
        return view('facility.elimination.matches', compact('elimination'));
    }
