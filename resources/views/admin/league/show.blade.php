...
@section('content')
    ...
    <div class="card card-info">
            ...
            <div class="dropdown float-right">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                    ...
                    @if($league->is_started)
                        ...
                        <a class="dropdown-item" style="color: #000;" href="{{ route('admin.league.fixture', $league->id) }}">Fikstürü Görüntüle</a>
                    @else
                        <form id="start-league-form" method="post" action="{{ route('admin.league.start', $league->id) }}">
                            @csrf
                        </form>
        ...
        <div class="card-body">
            ...
            <p class="text-muted">
                <a href="{{ route('admin.facility.show', $league->facility->id) }}">
