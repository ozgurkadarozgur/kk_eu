            ...
            <div class="dropdown float-right">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                    ...
                    @if($elimination->is_started)
                        ...
                        <a class="dropdown-item" style="color: #000;" href="{{ route('admin.elimination.matches', $elimination->id) }}">Eşleşmeleri Görüntüle</a>
                    @else
                        <form id="start-elimination-form" method="post" action="{{ route('admin.elimination.start', $elimination->id) }}">
                            @csrf
                        </form>
