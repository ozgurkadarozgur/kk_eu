...
@section('header')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Eleme Turnuvası Oluştur</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
@section('content')
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Eleme Turnuvası Oluştur</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" method="post" action="{{ route('facility.elimination.store') }}">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="max_team_count">Aşama Sayısı</label>
                    <input type="number" class="form-control" id="level_count" name="level_count" placeholder="Turnuvanın Aşama Sayısı">
                </div>
                <div class="form-group">
